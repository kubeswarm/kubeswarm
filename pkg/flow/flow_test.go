...
func TestDepsSucceeded(t *testing.T) {
	succeeded := &kubeswarmv1alpha1.PipelineStepStatus{Phase: kubeswarmv1alpha1.PipelineStepPhaseSucceeded}
	skipped := &kubeswarmv1alpha1.PipelineStepStatus{Phase: kubeswarmv1alpha1.PipelineStepPhaseSkipped}
	running := &kubeswarmv1alpha1.PipelineStepStatus{Phase: kubeswarmv1alpha1.PipelineStepPhaseRunning}
	pending := &kubeswarmv1alpha1.PipelineStepStatus{Phase: kubeswarmv1alpha1.PipelineStepPhasePending}
	failed := &kubeswarmv1alpha1.PipelineStepStatus{Phase: kubeswarmv1alpha1.PipelineStepPhaseFailed}

	status := map[string]*kubeswarmv1alpha1.PipelineStepStatus{
		"ok":      succeeded,
		"skip":    skipped,
		"running": running,
		"pending": pending,
