...
type TokenUsage struct {
	InputTokens  int64
	OutputTokens int64
	// ThinkingTokens is the count of thinking tokens consumed by reasoning-capable models (RFC-0033). Separate from OutputTokens, not additive. Zero on non-reasoning calls.
