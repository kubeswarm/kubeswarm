...
type TokenUsage struct {
	...
	// OutputTokens is the total number of final-answer/completion tokens generated
	// by the LLM. This does NOT include thinking tokens - those are counted
	// separately in ThinkingTokens.
	OutputTokens int64 `json:"outputTokens"`
	// ThinkingTokens is the number of tokens spent on the model's internal
...
const (
	...
	// PipelineStepPhaseWarmingUp means the step is waiting for its assigned agent's pods to
	// become ready after a scale-from-zero event. Transitions to Running once ready.
	PipelineStepPhaseWarmingUp PipelineStepPhase = "WarmingUp"
	PipelineStepPhaseRunning   PipelineStepPhase = "Running"
	// PipelineStepPhaseValidating means the step completed and is awaiting output validation.
	PipelineStepPhaseValidating PipelineStepPhase = "Validating"
	PipelineStepPhaseSucceeded  PipelineStepPhase = "Succeeded"
	PipelineStepPhaseFailed     PipelineStepPhase = "Failed"
	// PipelineStepPhaseSkipped means the step was bypassed because its If condition evaluated to false.
	PipelineStepPhaseSkipped PipelineStepPhase = "Skipped"
)
...
type PipelineStepStatus struct {
	...
	// ErrorCode is the structured error code when the step failed. Empty on success.
	// +optional
	ErrorCode string `json:"errorCode,omitempty"`
	// ErrorSuggestion is a user-facing hint for resolving the error. Empty on success.
	// +optional
	ErrorSuggestion string `json:"errorSuggestion,omitempty"`
