...
// +kubebuilder:validation:XValidation:rule="self.backend != 'vector-store' || has(self.embedding)",message="embedding config is required when backend is vector-store"
